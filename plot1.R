...
max <- max(data$Global_active_power)+0.5

png(filename = "plot1.png", width = 480, height = 480)
hist(data$Global_active_power, freq = T, breaks = seq(0,max, by=0.5), col = "red", main="Global Active Power", xlab = "Global Active Power (kilowatts)")
